...
class Wallet():
    ...
    def generate_blockchain_address(self):
        ...
        #4
        network_byte = b'00'
        nerwork_bitcoin_public_key = network_byte + ripemd160_bpk_hex
        nerwork_bitcoin_public_key_bytes = codecs.decode(
            nerwork_bitcoin_public_key, 'hex'
        )
        #5
        sha256_bpk = hashlib.sha256(nerwork_bitcoin_public_key_bytes)
        sha256_bpk_digest = sha256_bpk.digest()
        ...
        #7
        address_hex = (nerwork_bitcoin_public_key + checksum).decode('utf-8')
        #8
